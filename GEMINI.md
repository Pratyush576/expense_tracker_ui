...
## Core Directives
*   **Understanding the current project:** During the startup review the package/project/files thoroughly and build a detailed understanding. 
*   **README.md update** Check if README.md file exists in the root directory and create or update the document depending on whether it's existing or not
*   **ARCHITECTURE.md update** Check if docs/ARCHITECTURE.md file exists in the root directory and create or update the document depending on whether it's existing or not
