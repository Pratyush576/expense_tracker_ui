...
import { PeopleFill, CashStack, TagFill, ClipboardCheck, ClipboardData, FileEarmarkPlus, ArrowLeft, HouseFill, GiftFill } from 'react-bootstrap-icons'; // Import icons, including GiftFill
            ...
            <Row>
                <Col md={3} lg={2} className="bg-light sidebar">
                    <Nav className="flex-column">
                        ...
                        {isAdmin && <Nav.Link as={Link} to="sign-up-offer" className="d-flex align-items-center"><GiftFill className="me-2" />Sign-up Offer</Nav.Link>} {/* New NavLink */}
