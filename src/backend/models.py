...
class ActivityType(str, Enum):
    ...
    PROFILE_UNHIDDEN = "PROFILE_UNHIDDEN"

    ADMIN_ROLE_ASSIGNED = "ADMIN_ROLE_ASSIGNED"
    ADMIN_PRICING_CREATED = "ADMIN_PRICING_CREATED"
    ADMIN_PRICING_UPDATED = "ADMIN_PRICING_UPDATED"
...
class UserActivity(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    user_id: int = Field(foreign_key="user.id")
    profile_id: Optional[int] = Field(default=None, foreign_key="profile.id") # New field
